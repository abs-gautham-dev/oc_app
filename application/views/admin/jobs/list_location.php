				...
				<div class="box">
					<div class="box-header with-border">
                  		...
                  		<?php if(empty($doctor_id)){?>
                  			<a href="<?php echo base_url().'admin/jobs/add_location/'?>" title="" data-toggle="tooltip" data-original-title="Add Job" class="btn btn-default pull-right"><i class="fa fa-plus"></i></a>
                  		<?php }?>
                	</div>
								...
								{	
									...
									foreach ($records_result as $row) { $i++; 
										...
										<tr id="tr_<?php echo $row[$field]; ?>">
											...
											<td><?php if(!empty($row['lat'])) echo $row['lat']; ?></td>
											<td><?php if(!empty($row['long'])) echo $row['long']; ?></td>
