								...
								{	
									...
									?>
										<tr>
											...
											<td>
												<a id="edit_product" href="<?php echo base_url().'admin/user/feedback/view/'.$row['id']?>" class="btn btn-xs btn-success" title="" data-toggle="tooltip" data-original-title="View Details">
												<i class="fa fa-eye"></i>
												</a>
											</td>
										</tr>
