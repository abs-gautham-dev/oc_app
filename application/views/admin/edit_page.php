                                ...
                                <?php } ?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" placeholder="Content Here" class="form-control" id="ckeditor" rows="3" ><?php echo !set_value('content') ? $pages['content'] : set_value('content'); ?></textarea>
                                      ...
                                      <?php /* <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="seo_title" id="seo_title" value="<?php echo !set_value('seo_title') ? $pages['seo_title'] : set_value('seo_title'); ?>" placeholder="Seo Title" maxlength="150">
                                            <?php echo form_error('seo_title');?>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="seo_description" >Seo Description</label>
                                            <textarea name="seo_description" placeholder="Seo Description" class="form-control" rows="3"><?php echo !set_value('seo_description') ? $pages['seo_description'] : set_value('seo_description'); ?></textarea>
                                            <?php echo form_error('seo_description');?>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="seo_keywords" >Seo Keyword</label>
                                            <textarea name="seo_keywords" placeholder="Seo Keyword" class="form-control" rows="3"><?php echo !set_value('seo_keywords') ? $pages['seo_keywords'] : set_value('seo_keywords'); ?></textarea>
