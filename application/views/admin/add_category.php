	                  				...
	                  				<div class="box-body">
				                  		<div class="form-group">
											<label for="name">Name *</label>
											  	<input type="text" class="form-control" name="name" id="title" value="<?php echo set_value('name'); ?>" placeholder="Name" maxlength="50" data-parsley-required data-parsley-required-message="Please enter name.">
