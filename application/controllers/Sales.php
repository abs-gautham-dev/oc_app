...
class Sales extends CI_Controller {
	...
	public function order_list()
	{
		...
		$this->load->view('frontend/sales/send_order_list');
		$this->load->view('frontend/include/footer');
	}
	public function create_order()
	{
		 
		$data['title']="Create Order | ".SITE_TITLE;
		...
		if($this->input->post()){
		    ...
		    if(!$order_id = $this->Common_model->addEditRecords('sales_order', $update_data)) {
				...
				$suc = array('status' => '1', 'msg' => '<div class="alert alert-success"><strong>Success !</strong> Order Send Successfully.</div>');
		...
		$this->load->view('frontend/include/header',$data);
		$this->load->view('frontend/include/breadcrumb');
		$this->load->view('frontend/sales/create_order');
		$this->load->view('frontend/include/footer');
	}
